...
// Mock the controller
jest.mock('../../../controllers/beanBatch.controller', () => ({
  all: jest.fn(),
  one: jest.fn(),
  save: jest.fn(),
  update: jest.fn(),
...
const beanBatchController = require('../../../controllers/beanBatch.controller');

describe('BeanBatch Routes', () => {
  let router: Router;

  beforeEach(() => {
    router = beanBatchRoutes;
  });
