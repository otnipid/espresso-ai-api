...
// Mock the controller
jest.mock('../../../controllers/shotExtraction.controller', () => ({
  all: jest.fn(),
  one: jest.fn(),
  save: jest.fn(),
  update: jest.fn(),
...
const shotExtractionController = require('../../../controllers/shotExtraction.controller');

describe('ShotExtraction Routes', () => {
  let router: Router;

  beforeEach(() => {
    router = shotExtractionRoutes;
  });
