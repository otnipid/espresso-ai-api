...
// Mock the controller
jest.mock('../../../controllers/shotPreparation.controller', () => ({
  all: jest.fn(),
  one: jest.fn(),
  save: jest.fn(),
  update: jest.fn(),
...
const shotPreparationController = require('../../../controllers/shotPreparation.controller');

describe('ShotPreparation Routes', () => {
  let router: Router;

  beforeEach(() => {
    router = shotPreparationRoutes;
  });
