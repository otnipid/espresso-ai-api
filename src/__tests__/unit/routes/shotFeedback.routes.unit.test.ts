...
// Mock the controller
jest.mock('../../../controllers/shotFeedback.controller', () => ({
  all: jest.fn(),
  one: jest.fn(),
  save: jest.fn(),
  update: jest.fn(),
...
const shotFeedbackController = require('../../../controllers/shotFeedback.controller');

describe('ShotFeedback Routes', () => {
  let router: Router;

  beforeEach(() => {
    router = shotFeedbackRoutes;
  });
